...
class Stemmer {
    ...
    private doublec(j: number): boolean {
        if (j < 1) return false;
        if (this.b.charCodeAt(j) !== this.b.charCodeAt(j - 1)) return false;
        return this.cons(j);
    }
    ...
    private ends(s: string): boolean {
        ...
        const o = this.k - l + 1;
        if (o < 0) return false;
        for (let i = 0; i < l; i++) if (this.b.charCodeAt(o + i) !== s.charCodeAt(i)) return false;
        this.j = this.k - l;
        return true;
    }
    ...
    private setto(s: string): void {
        const l = s.length;
        const o = this.j + 1;
        for (let i = 0; i < l; i++) this.b = this.b.substr(0, o + i) + s[i] + this.b.substr(o + i + 1);
        this.k = this.j + l;
    }
    ...
    private step1(): void {
        if (this.b.charCodeAt(this.k) === 115) {
            ...
            else if (this.b.charCodeAt(this.k - 1) !== 115) this.k--;
        }
        if (this.ends('eed')) {
            if (this.m() > 0) this.k--;
            ...
            if (this.ends('at')) this.setto('ate');
                ...
                if (ch === 108 || ch === 115 || ch === 122) this.k++;
            } else if (this.m() === 1 && this.cvc(this.k)) this.setto('e');
        }
    }

    private step2(): void {
        if (this.ends('y') && this.vowelinstem()) this.b = this.b.substr(0, this.k) + 'i' + this.b.substr(this.k + 1);
    }
    ...
    private step5(): void {
        ...
        switch (b.charCodeAt(k - 1)) {
            ...
            case 110:
                ...
                return;
            case 111:
                if (this.ends('ion') && this.j >= 0 && (b.charCodeAt(this.j) === 115 || b.charCodeAt(this.j) === 116)) break;
                /* j >= 0 fixes Bug 2 */
    ...
    private step6(): void {
        ...
        if (this.b.charCodeAt(this.k) === 108 && this.doublec(this.k) && this.m() > 1) this.k--;
    }
