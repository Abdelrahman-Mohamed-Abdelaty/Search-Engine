...
exports.Axios = Axios;
},{"./lib/axios.js":"../../node_modules/axios/lib/axios.js"}],"results.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getQueryParam = exports.fetchData = void 0;
...
var queryTimeContainer = document.getElementById('query-time');
var getQueryParam = exports.getQueryParam = function getQueryParam(param) {
  var urlParams = new URLSearchParams(window.location.search);
  return urlParams.get(param);
};
var displayResults = function displayResults(pages) {
  ...
  pages.forEach(function (page) {
    ...
    resultItem.innerHTML = "\n                <h2>".concat(page.title, "</h2>\n                <a href=\"https://").concat(page.url, "\" target=\"_blank\">").concat(page.url, "</a>\n                <p>").concat(page.matchedContent, "</p>\n            ");
...
var fetchData = exports.fetchData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(query, page) {
    var startTime, response, endTime, queryTime;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          startTime = new Date();
          _context.next = 3;
          return (0, _axios.default)("/api/v1?search=".concat(query, "&page=").concat(page, "&limit=5"));
        case 3:
          response = _context.sent;
          endTime = new Date();
          queryTime = (endTime - startTime) / 1000;
          queryTimeContainer.textContent = "Query time: ".concat(queryTime, " seconds");
          if (response.data.pages.length !== 0) {
            displayResults(response.data.pages);
          } else {
            resultsContainer.innerHTML = "<p>No results found for: ".concat(query, "</p>");
          }
        case 8:
        case "end":
...
var nextPage = document.querySelector('.next-page-button');
if (nextPage) {
  nextPage.addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      var query, page;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            query = (0, _results.getQueryParam)('query');
            page = (0, _results.getQueryParam)('page') * 1 || 1;
...
var redirectToResults = function redirectToResults(query, page) {
  window.location.href = "results.html?query=".concat(encodeURIComponent(query), "&page=").concat(encodeURIComponent(page));
};
...
if (searchQuery) searchQuery.addEventListener('keypress', function (event) {
  if (event.key === 'Enter') {
    var _query = searchQuery.value;
    if (_query) {
      redirectToResults(_query, 1);
    }
  }
});
var query = (0, _results.getQueryParam)('query');
var page = (0, _results.getQueryParam)('page');
if (query) {
  (0, _results.fetchData)(query, page);
}
},{"./results":"results.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
