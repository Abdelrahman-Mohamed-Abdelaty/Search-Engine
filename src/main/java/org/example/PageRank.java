...
//        int[][] matrixData = {{1,1,0}, {1,0,0},{1,1,1}};
        int[][] matrixData = {{0,1,1}, {0,0,1},{1,1,1}};
...
//        double[]n = { 1.0,2,3};
        ...
        builder.buildGraphFromHTMLFiles("/home/abdelarhamn/Documents/SearchEngineJava/SearchEngineJava/Indexer/src/main/resources/sample");
//        //builder.printAdjacencyMatrix();
        double[] rank=start(builder.adjacencyMatrix,builder.adjacencyMatrix.length,1);
